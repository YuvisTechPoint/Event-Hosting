# Event Hosting Backend Architecture Overview

## Introduction

Event Hosting is an open-source event management and ticketing platform built with Laravel. The backend implements a **Domain-Driven Design (DDD)** architecture with clear separation of concerns, enabling maintainable, testable, and scalable code.
...
Event Hosting implements account-based multi-tenancy:
