    ...
    return (
        <>
            <Alert
                ...
                mb="lg"
            >
                {t`This report is for informational purposes only. Always consult with a tax professional before using this data for accounting or tax purposes. Please cross-reference with your Stripe dashboard as Event Hosting may be missing historical data.`}
            </Alert>
