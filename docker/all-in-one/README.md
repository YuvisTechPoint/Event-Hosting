# Event Hosting All-in-One Docker Image
...
the [Docker image](https://hub.docker.com/r/daveearley/Event Hosting-all-in-one), or create your own Docker compose file with the 
necessary [configurations for production](https://Event Hosting/docs/getting-started/deploying#configuring-environment-variables).
